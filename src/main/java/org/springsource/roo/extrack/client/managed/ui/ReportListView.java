...
public class ReportListView extends ReportListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.springsource.roo.extrack.client.managed.ui.ReportListView instance;
    ...
    public static org.springsource.roo.extrack.client.managed.ui.ReportListView instance() {
        if (instance == null) {
            instance = new ReportListView();
        }
        return instance;
    }
