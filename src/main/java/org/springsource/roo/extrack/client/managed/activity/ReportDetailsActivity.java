...
public class ReportDetailsActivity extends ReportDetailsActivity_Roo_Gwt {

    public ReportDetailsActivity(EntityProxyId<org.springsource.roo.extrack.client.proxy.ReportProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<org.springsource.roo.extrack.client.proxy.ReportProxy> view) {
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((ReportProxy) proxy);
