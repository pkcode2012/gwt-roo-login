...
public class ExpenseDetailsView extends ExpenseDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.springsource.roo.extrack.client.managed.ui.ExpenseDetailsView instance;
    ...
    public static org.springsource.roo.extrack.client.managed.ui.ExpenseDetailsView instance() {
        if (instance == null) {
            instance = new ExpenseDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, ExpenseDetailsView> {
    }
}
