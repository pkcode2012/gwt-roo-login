...
public abstract class EmployeeMobileListView_Roo_Gwt extends MobileProxyListView<EmployeeProxy> {

    protected Set<String> paths = new HashSet<String>();

    public EmployeeMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.springsource.roo.extrack.client.proxy.EmployeeProxy> renderer) {
