...
public class EmployeeDetailsView extends EmployeeDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.springsource.roo.extrack.client.managed.ui.EmployeeDetailsView instance;
    ...
    public static org.springsource.roo.extrack.client.managed.ui.EmployeeDetailsView instance() {
        if (instance == null) {
            instance = new EmployeeDetailsView();
        }
        return instance;
    }
