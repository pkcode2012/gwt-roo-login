...
public class EmployeeListView extends EmployeeListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.springsource.roo.extrack.client.managed.ui.EmployeeListView instance;
    ...
    public static org.springsource.roo.extrack.client.managed.ui.EmployeeListView instance() {
        if (instance == null) {
            instance = new EmployeeListView();
        }
        return instance;
    }
