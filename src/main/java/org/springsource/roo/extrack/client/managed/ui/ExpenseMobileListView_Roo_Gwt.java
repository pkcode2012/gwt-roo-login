...
public abstract class ExpenseMobileListView_Roo_Gwt extends MobileProxyListView<ExpenseProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ExpenseMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.springsource.roo.extrack.client.proxy.ExpenseProxy> renderer) {
